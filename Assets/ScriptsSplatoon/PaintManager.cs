...
public class PaintManager : Singleton<PaintManager>{
    ...
    private void Update() {
        Debug.Log("Boyama değeri" + paintValue);
        Debug.Log("textureID" + textureID);
        Debug.Log("uvOffsetID" + uvOffsetID);
        Debug.Log("uvIslandsID" + uvIslandsID);
        Debug.Log("colorID" + colorID);
        Debug.Log("blendOp"+ blendOpID);
    }
